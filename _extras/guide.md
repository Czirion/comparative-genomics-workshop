...
The main directory we will be using during the lesson is `/home/user/pan_workworkshop`. Ensure you are familiar with the structure of this directory to navigate easily during the workshop.
